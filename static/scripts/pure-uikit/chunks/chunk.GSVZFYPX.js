      ...
      if (index < this.maxOptionsVisible || this.maxOptionsVisible <= 0) {
        ...
        return html`
          <p-dropdown placement="top" behavior="hover">
            ...
            <div class="select__tags--overflow" @click=${(e) => e.stopPropagation()}>
      ...
      "select--large": this.size === "large"
          ...
          >
            ...
            <div class="select__listbox">
              ${hasPrependRowSlot ? html`<slot name="prepend-row" class="listbox__prepend" part="prepend-row"></slot>` : null}
              <div
                id="listbox"
                role="listbox"
                aria-expanded=${this.open ? "true" : "false"}
              ...
              ${hasAppendRowSlot ? html`<slot name="append-row" class="listbox__append" part="append-row"></slot>` : null}
            </div>
          </p-popup>
        </div>
...
__decorateClass([
  property({ type: Number, reflect: true, attribute: "max-count" })
], PSelect.prototype, "maxCount", 2);
__decorateClass([
  property({ type: Boolean, reflect: true, attribute: "tag-mode" })
