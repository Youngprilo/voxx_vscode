...
declare module "JitsiParticipant" {
    ...
    export default class JitsiParticipant {
         ...
         */
        constructor(jid: any, conference: any, displayName: any, hidden: boolean, statsID: string, status: string, identity: object, isReplacing: boolean | null, isReplaced: boolean | null, isSilent: boolean | null);
        _jid: any;
        _id: any;
        _conference: any;
        _displayName: any;
...
declare module "modules/RTC/BridgeChannel" {
    ...
    export default class BridgeChannel {
         ...
         */
        constructor(peerconnection?: RTCPeerConnection, wsUrl?: string, emitter: EventEmitter, conference: JitsiConference);
        _channel: any;
...
declare module "modules/statistics/PreCallTest" {
     ...
     */
    export default function runPreCallTest(iceServers: Array<IceServer>): Promise<PreCallResult | string>;
}
declare module "JitsiMeetJS" {
    ...
    import { PreCallResult } from "modules/statistics/PreCallTest";
    ...
    const _default_3: {
        ...
        */
         ...
         */
        runPreCallTest(iceServers: any): Promise<string | PreCallResult>;
        /**
